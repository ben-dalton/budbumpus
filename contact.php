...
class ContactPop {
    ...
    var $siteEmail = 'saddle_maker@hotmail.com';
    
    // the title of the emails that the form sends
    var $emailTitle = 'Website Form mail';
    
    var $thankYouMessage = "Thank you for your message, we'll get back to you shortly.";
    ...
    function getFormHtml($ajax = 0) {
        ...
        <div class="formItem">
            <input type="submit" value="Send" class="submit" /> $cancelLink
        </div>
...
<div id="contactForm">
    ...
    <form method="post" action="<?=$_SERVER['Contact-Pop/REQUEST_URI']; ?>">
